...
function openTab(tabId) {
    ...
    if (tabId == "existTabContent") {
        existTab.style.backgroundColor = "#444444";
        newTab.style.backgroundColor = "#666666";
        mapTab.style.backgroundColor = "#666666";
    }
    else if (tabId == "newTabContent") {
        newTab.style.backgroundColor = "#444444";
        existTab.style.backgroundColor = "#666666";
        mapTab.style.backgroundColor = "#666666";
    }
    else if (tabId == "mapTabContent") {
        newTab.style.backgroundColor = "#666666";
        existTab.style.backgroundColor = "#666666";
        mapTab.style.backgroundColor = "#444444";
    }
